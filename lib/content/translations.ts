/**
 * Pure helpers for presenting translation groups. No DB or DOM access, so they
 * are unit-testable in isolation. A "translation group" is the set of language
 * variants of one logical piece (shared translationGroupId).
 */
